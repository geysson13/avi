                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a tabindex="-1" href="css/plansaga.pdf">Servicios</a>
                                    </li>
            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li>
                            <a href="#"><span class="badge badge-info pull-right">8</span> Reportes</a>
                        </li>
                                     ...
                                     <form class="form-horizontal">
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">Introducir nombre</label>
                                          <div class="controls">
                                        ...
                                        <div class="control-group warning">
                                          ...
                                          <div class="controls">
                                            <input type="text" id="inputError" value="">
