            ...
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
                            <li class="active">
                                <a href="#">Panel de control administrador</a>
                            </li>
                            <li class="dropdown">
            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                                     ...
                                     <form class="form-horizontal">
                                      <fieldset>
                                        ...
                                        <div class="control-group success">
                                          <label class="control-label" for="inputError">Nombre del empleado</label>
                                          <div class="controls">
                                            <input type="text" id="inputError" value="Geysson López">
                                            <span class="help-inline">Prioritario</span>
                                          </div>
                                        <div class="control-group success">
                                          <label class="control-label" for="inputError">Nombre del proyecto</label>
                                          <div class="controls">
                                            <input type="text" id="inputError" value="plan Saga">
                                            <span class="help-inline">Prioritario</span>
                                          </div>
                                        </div>
                                        <div class="control-group success">
                                          <label class="control-label" for="selectError">Etapa del proyecto</label>
                                          <div class="controls">
                                            <select id="selectError" value= "iniciado">
					...
					<div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a href="principal2.php" class="btn btn-default">Confimar</a>
